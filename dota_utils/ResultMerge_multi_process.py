...
import time
import sys
import data_prepare.dota_utils as util
...
if __name__ == '__main__':
    # mergebypoly(r'data/result/val_p_split', r'data/result/val_p')
    mergebypoly(r'data/result/val-RBOX2-R50-800_split', r'data/result/val-RBOX2-R50-800')
    # mergebypoly(r'data/result/test_p_split', r'data/result/test_p')
    # mergebypoly(r'data/result/old_split', r'data/result/old')
    # mergebyrec()
    # pass
