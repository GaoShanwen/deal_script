...
if __name__ == '__main__':
    DOTA2COCO(r'./data/DOTA-v1/data_ori/train', r'./result/cpt_Hbox_train_label', wordname_15)
    DOTA2COCO(r'./data/DOTA-v1/data_ori/val', r'./result/cpt_Hbox_val_label', wordname_15)
